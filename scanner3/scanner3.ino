/*
 * BLE Room Positioning System - Anchor Scanner 03
...
// ============================================================
// ANCHOR CONFIGURATION - UNIQUE TO SCANNER-03
// ============================================================
const char* anchorId = "scanner-03";
const float anchorX = 5.0;    // Position in meters (X-axis)
const float anchorY = 8.0;    // Position in meters (Y-axis)
