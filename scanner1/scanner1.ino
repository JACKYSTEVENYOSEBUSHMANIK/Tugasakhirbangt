/*
 * BLE Room Positioning System - Anchor Scanner 01
...
// ============================================================
// ANCHOR CONFIGURATION - UNIQUE TO SCANNER-01
// ============================================================
const char* anchorId = "scanner-01";
const float anchorX = 0.0;    // Position in meters (X-axis)
